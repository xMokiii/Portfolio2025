                ...
                >
                  <div className="flip-card-inner w-full h-[30vh] sm:h-[35vh] md:h-[40vh] lg:h-[33vh] rounded-2xl">
                    ...
                    <div className="flip-card-back w-full h-full rounded-2xl flex flex-col justify-center items-center bg-gray-800 text-white p-4">
                      <h2 className="3xl:text-4xl text-xl font-bold 3xl:mb-2">{projet.titre}</h2>
                      <h3 className="3xl:text-xl text-base text-gray-400 mb-2">Détails du projet</h3>
                      <p className="text-xs 3xl:text-lg  mx-5">{projet.details}</p>
                      <div className="3xl:mt-2 mt-1 flex flex-wrap justify-center gap-1 3xl:gap-2">
                        {projet.skills.split(",").map((skill, skillIndex) => (
                          <span
                            key={skillIndex}
                            className="bg-blue-500 text-white px-3 3xl:py-1 rounded-full text-xs 3xl:text-base lg:mt-1"
                          >
                            {skill}
                          </span>
                        ))}
